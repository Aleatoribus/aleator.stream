...
?>
			...
			Welcome to Aleator Stream! Your use and access to Aleator Stream referred to as service, site, or website are included below. You are accepting these terms when using this service. If needed, these terms might be changed.
			</p>
			...
			<p style="font-size: 85%;">
			Aleator Stream is licensened under the <a href="/license.php">Apache License, Version 2.0.</a>
			</p>
			...
			<p style="font-size: 85%;">
			We do not collect any user data, beyond data that is required to provide the service. This data includes your username, and your hashed password.
			</p>
			...
			<h3>Privacy of Your Content</h3>

			<p style="font-size: 85%;">
			All content uploaded to Aleator Stream has its own URL. If, on upload, you do not select 'Make shareable' that content is only accessible by you via that link.
			</p>

			<p style="font-size: 85%;">
			Your profile page, including all of your uploads and notes, are only visible to you while you're logged in.
			</p>

			<h3>Jurisdiction</h3>

			<p style="font-size: 85%;">>
			These terms and conditions will be governed in accordance with the laws of Australia, and any disputes relating to these terms and conditions will be subject to the nonexclusive jurisdiction of the courts.
			</p>
